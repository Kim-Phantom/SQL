...
INSERT INTO ex3_1 (num2) VALUES(12345.2345);
INSERT INTO ex3_1 (num2) VALUES(123459.2345);
INSERT INTO ex3_1 (num2) VALUES(12345679.2345);  --오류 전체 7자리

/*
날짜 데이터 타입 (DATE(년월이시분초), TIMESTAMP(년월일시분초밀리초))
*/
...
-- sysdate 현재시간 date타입으로, systimestamp 현재시간 timestamp타입으로
...
INSERT INTO ex3_3 (user_id) VALUSE('a001');
SELECT*
FROM ex3_3;
/*
제약조건 
NOT NULL 널을 혀용하지 않겠다.
UNIQUE   중복을 허용하지 않겠다.
CHECK    특정 데이터만 받겠다
...
CREATE TABLE ex3_4
   ...
   ,CONSTRAINT uq_ex3_4 UNIQUE(mem_email) --제약조건 이름을곤리하고 싶을때
);
INSERT INTO ex3_4(mem_id, mem_email) VALUES('a001', 'A001@gmail.com');
INSERT INTO ex3-4(mem_id, mem_email) VALUES('a001', 'A001@gmail.com'); --오류 unique
INSERT INTO ex3-4(mem_nm) VALUES('팽수'); --오류 id,email notnull
SELECT * FROM ex3_4;
SELECT *
...
; --join 뒤에서 배울내용 테이블간 관게를 맺는 방법

-- drop table dep cascade constraints --제약조건 제거 후 테이블 삭제